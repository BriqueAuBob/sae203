...
CREATE TABLE movies (id TINYINT(4) AUTO_INCREMENT NOT NULL,
name VARCHAR(50),
picture VARCHAR(30),
description TEXT,
release_date DATE,
...
CREATE TABLE actors (id TINYINT(4) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE genres (id TINYINT(4) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE movies_actors (film_id TINYINT(4) NOT NULL, acteur_id TINYINT(4) NOT NULL, PRIMARY KEY (film_id, acteur_id)) ENGINE=InnoDB;

DROP TABLE IF EXISTS movies_genres;
CREATE TABLE movies_genres (genre_id TINYINT(4) NOT NULL, film_id TINYINT(4) NOT NULL, PRIMARY KEY (genre_id, film_id)) ENGINE=InnoDB;
